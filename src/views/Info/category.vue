                        ...
                        <div class="category" v-for="firstItem in category.item" :key="firstItem.id">
                            <h4>
                                ...
                                <div class="button-group">
                                    ...
                                    <el-button size="mini" @click="deleteCategoryComfirm(firstItem.id)" round>删除</el-button>
                                </div>
                            </h4>
                            <ul v-if="firstItem.children">
                                <li v-for="childrenItem in firstItem.children" :key="childrenItem.id">
                                    ...
                                    <div class="button-group">
                                        <el-button size="mini" type="danger" @click="editCategory()" round>编辑</el-button>
...
export default {
    ...
    setup(props, { root, refs }) {
        ...
        return  {
            ...
            // reactive
            form, category,deleteCategoryComfirm,deleteCategory,deleteCategory,editCategory,
            // methods
            submit, addFirst
        }
    }
